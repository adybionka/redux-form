        ...
        function Form() {
          ...
          return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.destroyed = false, _this.fieldValidators = {}, _this.lastFieldValidatorKeys = [], _this.fieldWarners = {}, _this.lastFieldWarnerKeys = [], _this.innerOnSubmit = undefined, _this.submitPromise = undefined, _this.getValues = function () {
            ...
            if (asyncValidate) {
              ...
              var fieldNeedsValidationForBlur = asyncBlurFields && ~asyncBlurFields.indexOf(name.replace(/\[[0-9]+\]/g, '[]'));
              var fieldNeedsValidationForChange = asyncChangeFields && ~asyncChangeFields.indexOf(name.replace(/\[[0-9]+\]/g, '[]'));
              var formHasAsyncFields = !asyncBlurFields && !asyncChangeFields;
              var fieldNeedsValidation = !submitting && (formHasAsyncFields || (trigger === 'blur' ? fieldNeedsValidationForBlur : fieldNeedsValidationForChange));
